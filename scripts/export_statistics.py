        ...
        for mode_name, mode_payload in split_payload.items():
            ...
            for source_row in per_source:
                ...
                row = {
                    ...
                    "nugget_codebook_bits": source_row.get("nugget_codebook_bits"),
                    "nugget_vq_num_codes": source_row.get("nugget_vq_num_codes"),
                    "nugget_codebook_size": source_row.get("nugget_codebook_size"),
                    ...
                    "nugget_codes_per_base": source_row.get("nugget_codes_per_base"),
